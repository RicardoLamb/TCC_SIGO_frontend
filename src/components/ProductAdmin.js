...
export default class ProductAdmin extends Component {
  ...
  onAddcodigoChange = event => this.setState({ newproduct: { ...this.state.newproduct, "codigo": event.target.value } });
                  ...
                  <div className="field has-addons">
                    <div className="control">
                      <input 
                        ...
                        value={this.state.newproduct.codigo}
